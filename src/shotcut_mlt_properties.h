...
/* ShotClip project annotations. These persist in MLT XML and are separate from
 * Shotcut's internal _shotcut:uuid used by selection and undo. */
#define kShotClipSchemaVersionProperty "shotclip:schemaVersion"
#define kShotClipProjectIdProperty "shotclip:projectId"
#define kShotClipTrackIdProperty "shotclip:trackId"
#define kShotClipClipIdProperty "shotclip:clipId"
#define kShotClipLinkIdProperty "shotclip:linkId"
