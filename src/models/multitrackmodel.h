...
public:
    ...
    int ensureShotClipIds();
    QString shotClipTrackId(int trackIndex) const;
    QString shotClipClipId(int trackIndex, int clipIndex) const;
    bool rippleDeleteRange(int position, int length);
